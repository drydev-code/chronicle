defmodule DryDev.Workflow.Engine.Instance.EventReplayer do
  @moduledoc """
  ...
  alias DryDev.Workflow.Engine.Diagrams.DiagramStore
  ...
  defp detect_implicit_waits(state, token_wait_states, open_message_waits, open_signal_waits) do
    alias DryDev.Workflow.Engine.Nodes.IntermediateCatch
  ...
  defp reregister_timers(state, open_timers) do
    ...
    Enum.reduce(open_timers, state, fn {_timer_id, timer_info}, acc ->
      ...
      timer_ref = make_ref()
      ref = Process.send_after(self(), {:timer_elapsed, token_id, timer_ref}, remaining_ms)
