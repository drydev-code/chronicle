defmodule Chronicle do
  @moduledoc """
  Public entry point for the Chronicle engine library.
  ...
  ## Usage
      ...
      children = [
        ...
        # Chronicle.children(opts) ++ your_children
      ]
  ...
  ## Options
    ...
    * `:eviction` — override eviction config (see `Chronicle.Engine.EvictionManager`)
  ...
  def child_spec(opts) do
    %{
      id: __MODULE__,
      start: {Chronicle.Supervisor, :start_link, [opts]},
      type: :supervisor
    }
  end
  ...
  """
  defdelegate children(opts \\ []), to: Chronicle.Supervisor, as: :children
end
