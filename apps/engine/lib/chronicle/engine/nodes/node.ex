defmodule Chronicle.Engine.Nodes.Node do
  @moduledoc "Node behaviour definition for all BPMN node types."

  @callback process(context :: Chronicle.Engine.ExecutionContext.t()) ::
    Chronicle.Engine.NodeResult.t()

  @callback continue_after_wait(context :: Chronicle.Engine.ExecutionContext.t()) ::
    Chronicle.Engine.NodeResult.t()
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour Chronicle.Engine.Nodes.Node
      alias Chronicle.Engine.{NodeResult, ExecutionContext, Token}
