defmodule Chronicle.Engine.Diagrams.SupportedFeatures do
  ...
  @supported_node_types MapSet.new(~w(
    ...
    scriptTask externalTask userTask rulesTask callActivity
    parallelGateway exclusiveGateway inclusiveGateway
    intermediateTimerEvent intermediateCatchTimerEvent intermediateCatchMessageEvent intermediateCatchSignalEvent
    intermediateThrowMessageEvent intermediateThrowSignalEvent intermediateThrowErrorEvent intermediateThrowEscalationEvent
  ...
  @unsupported_reasons %{
    ...
    "eventBasedGateway" => "Event-based gateways are not implemented.",
    "complexGateway" => "Complex gateways are not implemented.",
    "conditionalStartEvent" => "Conditional events are not implemented.",
    "intermediateCatchConditionalEvent" => "Conditional events are not implemented.",
    "conditionalBoundaryEvent" => "Conditional boundary events are not implemented.",
    "intermediateCatchLinkEvent" => "Link events are not implemented.",
    "intermediateThrowLinkEvent" => "Link events are not implemented.",
    ...
    "manualTask" => "Manual tasks are not implemented.",
    "sendTask" => "Send tasks are not first-class activities; use an intermediate throw message event.",
    "receiveTask" => "Receive tasks are not first-class activities; use an intermediate catch message event."
  }
