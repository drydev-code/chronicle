defmodule DryDev.WorkflowServer.Host.ExternalTasks.ServiceTask do
  @moduledoc "Template render + publish to bus for service tasks."
  alias DryDev.WorkflowServer.Host.ExternalTasks.Template
  alias DryDev.WorkflowServer.Host.VendorExtensions.ServiceTaskExtension
  ...
  defp build_and_publish(event, extension) do
    ...
    DryDev.WorkflowServer.Messaging.ServiceTaskPublisher.publish(service_task_event)
  end
