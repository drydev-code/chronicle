defmodule DryDev.WorkflowServer.Host.ExternalTaskRouter do
  @moduledoc """
  ...
  alias DryDev.WorkflowServer.Host.ExternalTasks.Handler
  alias DryDev.Workflow.Engine.Instance
  alias DryDev.Workflow.Engine.InstanceLoadCell
  ...
  @impl true
  def init(_) do
    Phoenix.PubSub.subscribe(DryDev.Workflow.PubSub, "engine:events")
    Phoenix.PubSub.subscribe(DryDev.Workflow.PubSub, "engine:external_tasks")
    {:ok, %{tasks: %{}}}
  end
