defmodule DryDev.WorkflowServer.Web.Controllers.TelemetryController do
  use Phoenix.Controller, formats: [:json]

  alias DryDev.WorkflowServer.Host.TelemetryService
  alias DryDev.Workflow.Persistence.Repo
  alias DryDev.Workflow.Persistence.Schemas.{CompletedInstance, TerminatedInstance}
  import Ecto.Query
