defmodule Chronicle.Server.Web.Router do
  ...
  scope "/api", Chronicle.Server.Web.Controllers do
    ...
    post(
      "/process-instance/conditional-starts",
      ProcessInstanceController,
      :evaluate_conditional_starts
    )
    ...
    post(
      "/management/external-tasks/:task_id/cancel",
      ManagementController,
      :cancel_external_task
    )

    get("/management/connectors", ConnectorRegistryController, :index)
    get("/management/connectors/:id", ConnectorRegistryController, :show)
    ...
    get(
      "/telemetry/process-instance-telemetries",
      TelemetryController,
      :process_instance_telemetries
    )
    ...
    get(
      "/telemetry/db-terminated-instance/:id",
      TelemetryController,
      :db_terminated_instance_data
    )
  end
  ...
  scope "/api", Chronicle.Server.Web.Controllers do
    ...
    delete("/management/connectors/:id", ConnectorRegistryController, :delete)
  end
end
