defmodule Chronicle.Server.Host.ExternalTasks.UserTask do
  @moduledoc "Form extraction + actor assignment for user tasks."
  alias Chronicle.Server.Host.ExternalTasks.Template
  alias Chronicle.Server.Host.VendorExtensions.UserTaskExtension
  ...
  defp build_user_task(event, extension) do
    ...
    Chronicle.Server.Messaging.UserTaskPublisher.publish(user_task_command)
  end
