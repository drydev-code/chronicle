defmodule DryDev.Workflow.Engine.Nodes.IntermediateThrow do
  ...
  defmodule ErrorEvent do
    ...
    def process(context) do
      node = context.node
      NodeResult.complete(%DryDev.Workflow.Engine.CompletionData.Error{
  ...
  defmodule EscalationEvent do
    ...
    def process(context) do
      node = context.node
      NodeResult.complete(%DryDev.Workflow.Engine.CompletionData.Escalation{
