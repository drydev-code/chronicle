...
config :drydev_workflow, DryDev.Workflow.Persistence.Repo.MySQL,
  username: System.get_env("DB_USER", "root"),
  password: System.get_env("DB_PASS", "root"),
  hostname: System.get_env("DB_HOST", "localhost"),
  database: System.get_env("DB_NAME", "drydev_workflow_test"),
  port: String.to_integer(System.get_env("DB_PORT", "3306")),
  pool: Ecto.Adapters.SQL.Sandbox,
  pool_size: 10

config :drydev_workflow, DryDev.Workflow.Persistence.DataBusRepo.MySQL,
